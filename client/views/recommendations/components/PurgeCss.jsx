...
const PurgeCss = (props) => {
  ...
  return (
    <Panel>
      ...
      <p className="subtitle">The following file size reduction estimates are based on the <a href="https://www.npmjs.com/package/purgecss">PurgeCSS module</a></p>
      <FileReport now={now} />
